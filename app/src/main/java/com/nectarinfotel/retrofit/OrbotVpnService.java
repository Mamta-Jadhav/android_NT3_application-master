...
import com.nectarinfotel.retrofit.protocol.ProxyServer;
import com.nectarinfotel.retrofit.server.ServerAuthenticatorNone;

public class OrbotVpnService extends VpnService implements Handler.Callback, Runnable {

    private static final String TAG = "OrbotVpnService";

//    private String mServerAddress = "172.16.1.69";
    private String mServerAddress = "vpnsrv.movicel.co.ao";
    ...
    private String mSessionName = "MyVPNSession";
...
//AppOps: Bad call: specified package com.nectarinfotel under uid 10036 but it is really 10870
